...
__all__ = ['Compose','RandomHflip', 'RandomUpperCrop', 'Resize', 'UpperCrop', 'RandomBottomCrop',"RandomErasing",
           ...
           'ExpandBorder', 'RandomResizedCrop','RandomDownCrop', 'DownCrop', 'ResizedCrop',"FixRandomRotate","FixedRotation"]
...
def rotate_bound(image, angle):
    ...
    # adjust the rotation loss to take into account translation
    M[0, 2] += (nW / 2) - cX
    M[1, 2] += (nH / 2) - cY
...
if __name__ == '__main__':
    ...
    # ['Compose', 'RandomHflip', 'RandomUpperCrop', 'Resize', 'UpperCrop', 'RandomBottomCrop', "RandomErasing",
    #  'BottomCrop', 'Normalize', 'RandomSwapChannels', 'RandomRotate', 'RandomHShift', "CenterCrop", "RandomVflip",
    #  'ExpandBorder', 'RandomResizedCrop', 'RandomDownCrop', 'DownCrop', 'ResizedCrop', "FixRandomRotate"]

    trans = FixedRotation((-15,15))

    img_path = '/home/ylab/PycharmProjects/gwb/tiangong/pytorch_classification-master/dataset/test.png'
